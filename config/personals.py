...
# Your legal name
first_name = "Kramikkumar"               # Your first name in quotes Eg: "First", "Sai"
middle_name = "Nareshbhai"             # Your name in quotes Eg: "Middle", "Vignesh", ""
last_name = "Nakrani"                # Your last name in quotes Eg: "Last", "Golla"

# Phone number (required), make sure it's valid.
phone_number = "9328890603"        # Enter your 10 digit number in quotes Eg: "9876543210"

# What is your current city?
current_city = "Surat"                  # Los Angeles, San Francisco, etc.
'''
...
street = "Yamuna Palace, Surat."                        # Please add your street address here
state = "Gujarat"
zipcode = "394101"                       # Please add your postal code here
country = "India"
